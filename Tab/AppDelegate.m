...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSLog(@"Window size: %@", NSStringFromCGRect([[UIScreen mainScreen] bounds]));
    ...
    UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:controller4];
    controller4.view.backgroundColor = [UIColor orangeColor];
    tabController.viewControllers = @[ controller1,
                                       controller2,
                                       controller3,
                                       navController
                                       ];
